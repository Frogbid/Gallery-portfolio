                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        ?>
                                            <tr>
                                                <td><img class="rounded-circle" width="35" src="../product/<?php echo $row['product_image']; ?>" alt=""></td>
                                                <td><?php echo $row['product_name']; ?></td>
                                                <td><?php echo $row['product_price']; ?></td>
                                                <td><?php echo $row['product_upload_date']; ?></td>
                                                <td><?php echo $row['product_status']; ?></td>
                                                <td>
													<div class="d-flex">
														<a href="#?product_id=<?php echo $row['product_id']; ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
														<a href="#?product_id=<?php echo $row['product_id']; ?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
													</div>												
												</td>												
                                            </tr>
                                        <?php } ?>
...
<!-- Mirrored from zenix.dexignzone.com/xhtml/table-datatable-basic.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 29 Aug 2021 04:52:15 GMT -->
</html>