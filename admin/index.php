...
if(isset($_POST['add_product'])){
    ...
    $product_image =  $result.'_'.$_FILES['product_image']['name'];
    $file_size = $_FILES['product_image']['size'];
    $file_tmp = $_FILES['product_image']['tmp_name'];

    $con->query("insert into product(`product_name`,`product_price`,`product_image`) values('" . $product_name . "','" . $product_price . "','" . $product_image . "')");

    if(move_uploaded_file($file_tmp, '../' . "product/" . $product_image)){
?>
        <script>
            alert("submit");
        </script>
    ...
    <div class="deznav">
        <div class="deznav-scroll">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li><a href="table-datatable-basic.php" aria-expanded="false">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="val-username1">Image name
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" id="val-username1"
                                                           name="product_name" placeholder="Enter a imagename..">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="val-currency">Image price
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" id="val-currency"
                                                           name="product_price" placeholder="$21.60">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="file" name="product_image" id="input-file-now-custom-2" class="dropify" data-height="500">
                                                </div>
                                            </div>
                                            <div class="form-group row">
